...
export default function HomeAdd() {
	return (
		<div className="relative bg-yellow-50">
			...
			{/* Content */}
			<div className="relative flex flex-col items-center justify-center py-16 px-4 lg:flex-row lg:justify-between lg:px-20">
				{/* Text Section */}
				<motion.div
				...
				>
					...
					<h1 className="prata-regular text-3xl text-black mb-4">
					...
					<div className="flex justify-center lg:justify-start space-x-4">
						<img
							...
							className="h-12 hover:scale-110 transition ease-in-out"
						/>
						<img
